            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold">Create New Outcome</h1>
                            <p className="text-muted-foreground">Add a new project deliverable or outcome</p>
                        </div>
                    </div>
                </div>
