...
export default function EditProgram({ program }: EditProgramProps) {
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        national_alignment: program.nationalAlignment || '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(programsRoutes.update(program.id).url, {
            onSuccess: () => {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Update program information and settings</p>
                        </div>
                    </div>
                </div>
