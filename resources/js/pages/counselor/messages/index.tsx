...
interface CounselorMessagesProps {
...
export default function CounselorMessages({ sessionsWithChats = [], users = [], messages = [] }: CounselorMessagesProps) {
    ...
    const handleSendMessage = () => {
        if ((newMessage.trim() || selectedFile) && selectedSession) {
            ...
            router.post(`/counselor/messages/${selectedSession.id}`, formData, {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
                    setNewMessage('');
                            ...
                            <>
                                ...
                                <div className="p-4 bg-background border-b border-border flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <Link
                                            href={`/counselor/messages/${selectedSession.id}`}
                                    ...
                                    <div className="max-w-4xl mx-auto space-y-4">
                                        {messages && messages.length > 0 ? (
                                            messages.map((message) => (
                                                <div key={message.id} className={`flex ${message.is_from_counselor ? 'justify-end' : 'justify-start'}`}>
                                                    <div className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${
                                                        message.is_from_counselor
