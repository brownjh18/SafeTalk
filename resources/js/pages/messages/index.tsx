...
export default function Messages({ sessionsWithChats = [], users = [], messages = [] }: MessagesProps) {
    ...
    const handleSendMessage = () => {
        if ((newMessage.trim() || selectedFile) && selectedSession) {
            ...
            router.post(`/messages/${selectedSession.other_user.id}`, formData, {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
                    setNewMessage('');
                                                ...
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1">
                                                            <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${
                                                                session.other_user?.role === 'admin' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' :
                                                                session.other_user?.role === 'counselor' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300' :
                                                                'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300'
                                                            }`}>
                                                                {session.other_user?.role || 'user'}
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className="p-4 bg-background border-b border-border flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${
                                                    selectedSession.other_user?.role === 'admin' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' :
                                                    selectedSession.other_user?.role === 'counselor' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300' :
                                                    'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300'
                                                }`}>
                                                    {selectedSession.other_user?.role || 'user'}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <Link
                                            href={`/messages/${selectedSession.other_user.id}`}
