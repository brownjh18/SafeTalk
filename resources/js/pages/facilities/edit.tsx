...
export default function EditFacility({ facility, types }: EditFacilityProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(facilitiesRoutes.update(facility.id).url, {
            onSuccess: () => {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Update facility information and settings</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end space-x-4">
                        ...
                        >
                            ...
                            {processing ? 'Updating...' : 'Update Facility'}
                        </button>
                    </div>
                </form>
            </div>
